...
export const Template01 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 30, left: 60 }}><BrandLogo color={logoColor} size={24} /></div>
  </div>
);

export const Template02 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
...
export const Template03 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 30, left: 50 }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);

export const Template04 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    <div style={{ position: "absolute", inset: 0, background: image ? `url(${image}) center/cover` : IMG_PLACEHOLDER }} />
...
export const Template05 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: "#fff" }}>
    ...
    <div style={{ position: "absolute", bottom: 30, right: 60 }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);

export const Template06 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
...
export const Template07 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 20, right: 60 }}><BrandLogo color={logoColor} size={20} /></div>
  </div>
);

export const Template08 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 25, right: 60 }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);

export const Template09 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => {
...
export const Template10 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", top: 0, right: 0, width: W * 0.4, height: H, background: color, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 40px" }}>
      ...
      <div style={{ marginTop: 40 }}><BrandLogo color={logoColor} size={20} /></div>
    </div>
  </div>
);
