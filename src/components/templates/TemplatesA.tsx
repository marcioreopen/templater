...
export const Template01 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
...
export const Template02 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
...
export const Template03 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
...
export const Template04 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    <div style={{ position: "absolute", inset: 0, background: image ? `url(${image}) center/cover` : IMG_PLACEHOLDER }} />
...
export const Template05 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
...
export const Template06 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
...
export const Template07 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
...
export const Template08 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
...
export const Template09 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => {
...
export const Template10 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080 }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
