...
export const Template11 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
...
export const Template12 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
...
export const Template13 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: color }}>
...
export const Template14 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: color }}>
...
export const Template15 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: color }}>
...
export const Template16 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: "#fff" }}>
...
export const Template17 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: color }}>
...
export const Template18 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: color }}>
...
export const Template19 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
  <div style={{ ...baseCanvas, background: "#fff" }}>
...
export const Template20 = ({ color, title, text, image, titleSize = 100, textSize = 100 }: TemplateProps) => (
