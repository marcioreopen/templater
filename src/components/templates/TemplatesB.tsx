...
export const Template11 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 30, left: 70 }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);

export const Template12 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: "#fff" }}>
    ...
    <div style={{ position: "absolute", bottom: 20, left: "50%", transform: "translateX(-50%)" }}><BrandLogo color={logoColor} size={20} /></div>
  </div>
);

export const Template13 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 25, right: 70 }}><BrandLogo color={logoColor} size={20} /></div>
  </div>
);

export const Template14 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 30, left: "50%", transform: "translateX(-50%)" }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);

export const Template15 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 30, left: 60 }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);

export const Template16 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: "#fff" }}>
    ...
    <div style={{ position: "absolute", bottom: 30, left: 50 }}><BrandLogo color={logoColor} size={20} /></div>
  </div>
);

export const Template17 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 20, right: 40 }}><BrandLogo color={logoColor} size={20} /></div>
  </div>
);

export const Template18 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: color }}>
    ...
    <div style={{ position: "absolute", bottom: 20, right: 30 }}><BrandLogo color={logoColor} size={18} /></div>
  </div>
);

export const Template19 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: "#fff" }}>
    ...
    <div style={{ position: "absolute", top: 60, left: 40, bottom: 60, width: W * 0.35, background: color, borderRadius: 20, display: "flex", flexDirection: "column", justifyContent: "center", padding: "0 36px", boxShadow: "10px 0 40px rgba(0,0,0,0.3)" }}>
      ...
      <div style={{ marginTop: 30 }}><BrandLogo color={logoColor} size={18} /></div>
    </div>
  </div>
);

export const Template20 = ({ color, title, text, image, titleSize = 100, textSize = 100, canvasWidth: W = 1080, canvasHeight: H = 1080, logoColor = "#FFFFFF" }: TemplateProps) => (
  <div style={{ ...canvas(W, H), background: "#fafafa" }}>
    ...
    <div style={{ position: "absolute", bottom: 40, left: "50%", transform: "translateX(-50%)" }}><BrandLogo color={logoColor} size={22} /></div>
  </div>
);
